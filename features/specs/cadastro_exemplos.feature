...
| 'paula_ruby_now_1@guts.com' | 'masc' | 'Paula'    | 'Silva'   | '12345678' | '10' | 'March' | '1980' | 'no'       | 'Rua A, 54' | 'São Leopoldo'  | '70690' | 'Illinois' | 5551999999999 | 'Casa'         |
| 'joao_ruby_now_1@guts.com'  | 'fem'  | 'João'     | 'Santos'  | '89101112' | '15' | 'April' | '1990' | 'yes'      | 'Rua B, 56' | 'Novo Hamburgo' | '80765' | 'Nebraska' | 5551988888888 | 'Trabalho'     |